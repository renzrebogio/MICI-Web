        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <section>
              ...
              <p className="mb-4">
                "Personal Information" is any information or combination of information that relates to you, and can be used to identify you. Personal Information may include the following: information you make available to us when you open an account or use our services, such as your: Name of the Insured, Email Address, Home Address, Office Address, Mailing Address, Telephone No, Cellphone No, Nature of Business/Occupation, TIN, Valid ID Information which you make available to our services as you use them, including Shared Information you make available to others through our services and information you store using our services, Shared Information that others using our services make available about you, such as information contained in posts they make and communications they make to you and others using our services; and Information we collect as you access our website or use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                The collected signature, full address, email, contact details and other information as listed above will be used in your transactions with <strong>Metropolitan Insurance Company Inc</strong>. By agreeing to the Terms and Conditions and this Privacy Policy, you are authorizing Metropolitan Insurance Company Inc. to use your submitted information to facilitate transactions in your behalf as deemed authorized by you and such authorization shall extend to third parties with whom we have data sharing agreements.
              </p>
              <p className="mb-4">We may use your Information for any of the following purposes:</p>
              
              <div className="ml-6 space-y-4">
                <div>
                  <h3 className="font-bold mb-2">To enable us to perform our transactions with you</h3>
                  <p>
                    To provide our services and verify your identity. To approve, facilitate, administer and process applications and transactions; send you statements, billings, notices and other such documents necessary for continued use of our products and services; To conduct studies and researches for the purpose of reviewing, developing and improving our products and services; To perform profile analysis, behavioral modeling and analytics to understand needs, preferences and market trends to be able to improve and recommend suitable products and services; For customer service, security, fraud-detection, archival and backup purposes in connection with the provision of our services.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    To reach out to you regarding products and services information, including offers, promotions, discounts, rewards; and for personalizing your experience with our various touchpoints such as call center, telemarketing, email, messaging and other channels; To respond to your queries, requests and complaints and improve how we interact with you; To provide you with advertising and direct marketing that is more relevant to you.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold mb-2">To improve our services</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-bold mb-2">To protect our Company's interest</h3>
                  <p>
                    To perform certain protective safeguards against improper use or abuse of our products and services including fraud prevention; To comply and/or perform our operational, audit, administrative, credit and risk management processes, policies and procedures, including credit check, verification and reporting; To review and/or comply with the terms and conditions governing our products, services, facilities and channels; Carry out payment collection activities through the Company's Collection Department; Enable the Company to pursue reasonable and legally permissible remedies in accordance with this Agreement and under applicable laws.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold mb-2">To comply with applicable laws and legal processes</h3>
                  <p>
                    To comply with legal and regulatory requirements of government regulators, judicial supervisory bodies, tax authorities or courts of competent jurisdiction, as the same may be amended or supplemented from time to time; Comply with court order and other legal processes; Respond to governmental inquiries or requests from public authorities; Prevent fraud, violation of contracts, violations of law, and misuse of our products and services.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p className="mb-4">
                You agree that we or our affiliate companies may be required to retain, preserve or disclose your Personal Information: in order to comply with applicable laws or regulations; in order to comply with a court order, subpoena or other legal process; in response to a request by a government authority, law enforcement agency or similar body (whether situated in your jurisdiction or elsewhere); or where we believe it is reasonably necessary to comply with applicable laws or regulations. You also agree that we or our affiliate companies may need to disclose your Personal Information in order to enforce <strong>Metropolitan Insurance Company Inc.'s</strong> Terms and Conditions or this Privacy Policy, protect our rights, property or safety, or the rights, property or safety of our affiliate companies or other users of our services.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4">A Word About Shared Information</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">Communications From Us</h2>
              
              <h3 className="font-bold mb-2 mt-4">Newsletters and other types of communications</h3>
              <p className="mb-4">
              ...
              <h3 className="font-bold mb-2">Service-related announcements</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">A Word About Sensitive Personal Information</h2>
              <p className="mb-4">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-3">
                <li>
                  <strong>Right to be informed and to request access.</strong> You have the right to ask whether your personal information is being or has been processed. Consequently, you have the right to access such personal data that we process.
                </li>
                <li>
                  <strong>Right to object.</strong> You have the right to object to the processing of your personal data, including processing for direct marketing, automated processing or profiling.
                </li>
                <li>
                  <strong>Right to withhold consent.</strong> You shall also be notified and given an opportunity to withhold consent to the processing of your personal information in case of changes in our privacy policies and other information we provide you. However, your withdrawal of consent may mean that we will not be able to continue providing our services to you or we may need to terminate our existing relationship and your contract with us, etc. as the case may be, which we will inform you of.
                </li>
                <li>
                  <strong>Right to rectification.</strong> You have the right to dispute the inaccuracy or error in your personal information and we shall correct it immediately and accordingly, unless the request is vexatious or otherwise unreasonable.
                </li>
                <li>
                  <strong>Right to erasure/blocking.</strong> You shall have the right to suspend, withdraw or order the blocking, removal or destruction of your personal data from our database in the following circumstances: (1) your personal data is no longer necessary for the purposes for which it was collected or processed; (2) you withdraw your consent or object to the processing of your personal information, and no other legal ground or overriding legitimate interests exists for us to continue processing the same; (3) you believe that we have processed your personal data unlawfully, or (4) the personal data you provided involves private information that is prejudicial to you.
                </li>
                <li>
                  <strong>Right to lodge a complaint.</strong> You have the right to approach us if there has been any violation of your rights as enumerated above. We shall exert our best efforts to address and settle any requests or complaints brought to our attention.
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">Transfer, Storage and Security of Your Personal Information</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">Period of Use of Your Personal Information</h2>
              <p className="mb-4">
            ...
            <section>
              ...
              <p className="mb-4">
                If you wish to contact us regarding this Privacy Policy or any privacy-related matters, please contact our Data Protection Officer via email at <a href="mailto:dpo@miciph.com" className="text-blue-600 hover:underline">dpo@miciph.com</a> or via postal mail to Metropolitan Insurance Company Inc. at 3rd Floor The Athenaeum Building, 160 L.P. Leviste Street, Salcedo Village, Makati City, Metro Manila, Philippines 1227 (Attention: Data Protection Officer).
              </p>
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <p className="font-bold mb-2">You may also write to our Data Protection Officers at:</p>
