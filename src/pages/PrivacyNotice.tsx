            ...
            <div className="prose prose-lg max-w-none space-y-10">
              ...
              <section>
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-start gap-3 p-3 bg-blue-50/80 backdrop-blur-sm rounded-lg">
                    <div className="w-1.5 h-1.5 bg-blue-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">providing our services to you.</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-blue-50/80 backdrop-blur-sm rounded-lg">
                    <div className="w-1.5 h-1.5 bg-blue-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">assisting us in carrying out the purposes set out under the "How We Use Your Information" section above.</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-blue-50/80 backdrop-blur-sm rounded-lg">
                    <div className="w-1.5 h-1.5 bg-blue-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">carrying out our obligations and enforcing our rights under the Metropolitan Insurance Company Inc.'s Terms and Conditions or this Privacy Policy; and/or</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-blue-50/80 backdrop-blur-sm rounded-lg">
                    <div className="w-1.5 h-1.5 bg-blue-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">improving our services.</span>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed mb-3">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-start gap-3 p-3 bg-red-50/80 backdrop-blur-sm rounded-lg border-l-2 border-red-600">
                    <div className="w-1.5 h-1.5 bg-red-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">to comply with applicable laws or regulations.</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-red-50/80 backdrop-blur-sm rounded-lg border-l-2 border-red-600">
                    <div className="w-1.5 h-1.5 bg-red-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">to comply with a court order, subpoena or other legal process.</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-red-50/80 backdrop-blur-sm rounded-lg border-l-2 border-red-600">
                    <div className="w-1.5 h-1.5 bg-red-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">in response to a request by a government authority, law enforcement agency or similar body (whether situated in your jurisdiction or elsewhere); or</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-red-50/80 backdrop-blur-sm rounded-lg border-l-2 border-red-600">
                    <div className="w-1.5 h-1.5 bg-red-600 rounded-full flex-shrink-0 mt-2"></div>
                    <span className="text-gray-700">where we believe it is reasonably necessary to comply with applicable laws or regulations.</span>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section>
                ...
                <div className="bg-indigo-50/80 backdrop-blur-sm p-6 rounded-lg mb-4 border-l-4 border-indigo-600">
                  <h4 className="text-xl font-semibold text-gray-900 mb-3">Newsletters and other types of communications</h4>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div className="bg-teal-50/80 backdrop-blur-sm p-6 rounded-lg border-l-4 border-teal-600">
                  <h4 className="text-xl font-semibold text-gray-900 mb-3">Service-related announcements</h4>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <section>
                ...
                <div className="bg-green-50/80 backdrop-blur-sm p-6 rounded-lg border-l-4 border-green-600">
                  <p className="text-gray-700 leading-relaxed">
              ...
              <section className="bg-gradient-to-r from-accent to-tertiary p-8 rounded-lg text-white shadow-lg">
                <h3 className="text-2xl font-bold mb-4">How To Contact Us</h3>
                ...
                <div className="leading-relaxed bg-white/10 p-4 rounded-lg backdrop-blur-sm">
