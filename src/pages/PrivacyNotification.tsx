    ...
    <>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <Link
            to="/privacy-policy"
            className="mb-6 inline-flex items-center gap-2 text-gray-800 hover:text-accent transition-colors group bg-white/70 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm"
          >
            <ArrowLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
            <span className="font-medium">Back to Data Privacy</span>
          </Link>

          <div className="bg-white/75 backdrop-blur-sm rounded-lg shadow-xl p-8 md:p-12 border border-primary/10">
            {/* Header Section */}
            ...
            {/* Content */}
            <div className="prose prose-lg max-w-none space-y-8 text-primary-foreground">
              {/* Greeting */}
              <div className="p-6 rounded-lg border-l-4 border-accent bg-accent/6">
                <p className="text-primary font-semibold text-lg mb-3">Dear Valued Client,</p>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-white/70 backdrop-blur-sm p-6 rounded-lg border-l-4 border-accent shadow-sm">
                    <h3 className="text-xl font-bold text-primary mb-3">Personal Information</h3>
                    <p className="leading-relaxed text-muted-foreground">
                  ...
                  <div className="bg-white/70 backdrop-blur-sm p-6 rounded-lg border-l-4 border-tertiary shadow-sm">
                    <h3 className="text-xl font-bold text-primary mb-3">Sensitive Personal Information</h3>
                    <p className="leading-relaxed text-muted-foreground">
                  ...
                  <div className="bg-white/70 backdrop-blur-sm p-6 rounded-lg border-l-4 border-primary shadow-sm">
                    <h3 className="text-xl font-bold text-primary mb-3">Privileged Information</h3>
                    <p className="leading-relaxed text-muted-foreground">
              ...
              <section>
                ...
                <div className="bg-accent/6 backdrop-blur-sm p-6 rounded-lg space-y-3 border border-accent/20">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-semibold">a</div>
                    <p className="leading-relaxed text-muted-foreground pt-1">To process your insurance application, renewal, and related requests;</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-semibold">b</div>
                    <p className="leading-relaxed text-muted-foreground pt-1">To administer your insurance policy/ies;</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-semibold">c</div>
                    <p className="leading-relaxed text-muted-foreground pt-1">To provide customer support, servicing, and claims assistance; and</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-white font-semibold">d</div>
                    <p className="leading-relaxed text-muted-foreground pt-1">To conduct research and data analytics to improve our products and services.</p>
                  </div>
                </div>

                <div className="bg-yellow-50/80 backdrop-blur-sm p-5 rounded-lg border-l-4 border-yellow-600 mt-6">
                  <p className="leading-relaxed text-muted-foreground">
              ...
              <section>
                ...
                <div className="bg-accent/6 backdrop-blur-sm p-6 rounded-lg border-l-4 border-accent">
                  <p className="leading-relaxed text-muted-foreground">
              ...
              {/* Closing */}
              <div className="bg-white/70 backdrop-blur-sm p-6 rounded-lg border-l-4 border-primary">
