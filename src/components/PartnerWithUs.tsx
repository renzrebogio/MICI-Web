...
const PartnerWithUs = () => {
  ...
  const partnershipPoints = [
    {
      ...
      description:
        "MICI has been engaged in insurance since 1933. It has been trusted by individuals and businesses from different industries such as hospitality, education, and telecommunications industry, among others.",
      position: "top",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description:
        "MICI is highly driven to build trust with their customers and allay their apprehensions by ensuring that they will get the value, and sometimes more, of what they paid for.",
      position: "bottom",
    },
    {
      id: 4,
  ...
  return (
    <div className="min-h-screen bg-gradient-secondary py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Discover the key advantages that make us your ideal insurance
            partner
          </p>
        </div>
        ...
        <div className="relative w-full max-w-4xl mx-auto">
          ...
          <div className="relative w-full pb-[100%] md:pb-[80%]">
            {" "}
            {/* Increased padding */}
            {/* Central Circle */}
            ...
            {partnershipPoints.map((point) => (
              <div
                key={`line-${point.id}`}
                className={getConnectorLine(point.position) + " z-10"}
              ></div>
            ))}
            {/* Partnership Cards */}
            {partnershipPoints.map((point) => {
              ...
              return (
                ...
                >
                  <div
                    ...
                    ${
                      activeCard === point.id
                        ? "scale-105 shadow-2xl border-teal-300"
                        : "hover:shadow-xl"
                    }
                  `}
                  >
